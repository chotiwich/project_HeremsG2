$(() => {
  ...
  function display() {
    var urlAPI = "http://localhost:8888/project/Hermes/api.php/getdb";
  ...
  function btnSearch_Click() {
    ...
    var urlAPI = "http://localhost:8888/project/Hermes/api.php/getdb/" + idcheck;
    $.getJSON(urlAPI).done(function (data) {
      // console.log(JSON.stringify(data));
      var line = "";
      $.each(data, function (k, item) {
  ...
  function displayroomva() {
    alert("oh");
    var urlAPI = "http://localhost:8888/project/Hermes/api.php/getroomva";
    $.getJSON(urlAPI).done(function (data) {
      // console.log(JSON.stringify(data));
